...
class LoginAndOverviewE2ETest {
    ...
    @Test
    void opensDemoBankAndChecksTitle() {
        System.out.println("Opening demo.testfire.net home page");
        driver.get("https://demo.testfire.net");

        String title = driver.getTitle();
        System.out.println("Page title: " + title);

        assertTrue(title.contains("Altoro") || title.contains("Mutual"));
    }
